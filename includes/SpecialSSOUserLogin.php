...
class SpecialSSOUserLogin extends UnlistedSpecialPage
{
	...
	private function processRedirect()
	{
		...
		file_put_contents('php://stderr', print_r('wgRequest',TRUE));
		file_put_contents('php://stderr', print_r($wgRequest,TRUE));
		...
		file_put_contents('php://stderr', print_r('returnToParam',TRUE));
		file_put_contents('php://stderr', print_r($returnToParam,TRUE));
		file_put_contents('php://stderr', print_r('returnToQueryParam',TRUE));
		file_put_contents('php://stderr', print_r($returnToQueryParam,TRUE));
		file_put_contents('php://stderr', print_r('base64returnToQueryParam',TRUE));
		file_put_contents('php://stderr', print_r($base64returnToQueryParam,TRUE));
